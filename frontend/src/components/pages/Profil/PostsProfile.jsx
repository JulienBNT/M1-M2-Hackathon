...
const PostProfile = ({ post, className = "" }) => {
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-sm border border-gray-100 mb-6 overflow-hidden ${className}`}
    >
      {post && (
